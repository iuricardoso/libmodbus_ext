...
ACLOCAL = ${SHELL} /media/iuri/OneDrive/Documentos/libmodbus_ext/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AS = as
AUTOCONF = ${SHELL} /media/iuri/OneDrive/Documentos/libmodbus_ext/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /media/iuri/OneDrive/Documentos/libmodbus_ext/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /media/iuri/OneDrive/Documentos/libmodbus_ext/build-aux/missing automake-1.15
AWK = mawk
CC = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /media/iuri/OneDrive/Documentos/libmodbus_ext/build-aux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 3.1.4
abs_builddir = /media/iuri/OneDrive/Documentos/libmodbus_ext
abs_srcdir = /media/iuri/OneDrive/Documentos/libmodbus_ext
abs_top_builddir = /media/iuri/OneDrive/Documentos/libmodbus_ext
abs_top_srcdir = /media/iuri/OneDrive/Documentos/libmodbus_ext
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /media/iuri/OneDrive/Documentos/libmodbus_ext/build-aux/install-sh
